...
class MarkerEntity extends LocationSharingEntityBase<Marker> {
  ...
  make(this: MarkerEntity) {
    return new MarkerEntity(this._client, this.entopts())
  }




  async list(this: any, reqmatch?: MarkerListMatch, ctrl?: Control): Promise<MarkerEntity[]> {
  ...
  async create(this: any, reqdata?: MarkerCreateData, ctrl?: Control): Promise<MarkerEntity> {
  ...
  async remove(
    this: any, reqmatch?: MarkerRemoveMatch, ctrl?: Control,
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<MarkerEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
