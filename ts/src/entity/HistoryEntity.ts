...
class HistoryEntity extends LocationSharingEntityBase<History> {
  ...
  async create(this: any, reqdata?: HistoryCreateData, ctrl?: Control): Promise<History> {
  ...
  async remove(this: any, reqmatch?: HistoryRemoveMatch, ctrl?: Control): Promise<History> {
