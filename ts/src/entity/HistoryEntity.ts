...
class HistoryEntity extends LocationSharingEntityBase<History> {
  ...
  async create(this: any, reqdata?: HistoryCreateData, ctrl?: Control): Promise<HistoryEntity> {
  ...
  async remove(
    this: any, reqmatch?: HistoryRemoveMatch, ctrl?: Control,
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<HistoryEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
