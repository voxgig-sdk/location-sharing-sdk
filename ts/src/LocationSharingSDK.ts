...
class LocationSharingSDK {
  ...
  async graphql(query: string, variables?: any, ctrl?: any) {
    ...
    if (null != errors && Array.isArray(errors) && 0 < errors.length) {
      ...
      const err: any = new Error('LocationSharingSDK: graphql: ' +
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  BuildingCheck(entopts?: Record<string, any>) {
    const self = this
    return new BuildingCheckEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  Marker(entopts?: Record<string, any>) {
    const self = this
    return new MarkerEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  Repeat(entopts?: Record<string, any>) {
    const self = this
    return new RepeatEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  Share(entopts?: Record<string, any>) {
    const self = this
    return new ShareEntity(self, entopts)
  }
