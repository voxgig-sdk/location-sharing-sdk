...
(0, node_test_1.describe)('MarkerDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-marker', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-marker', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    const env = (0, utility_1.envOverride)({
        'LOCATION_SHARING_TEST_MARKER_ENTID': {},
    ...
    if (live) {
        ...
        let idmap = env['LOCATION_SHARING_TEST_MARKER_ENTID'];
...
//# sourceMappingURL=MarkerDirect.test.js.map