...
(0, node_test_1.describe)('HistoryEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(null != history_ref01_data.id);
        // LIST
        const history_ref01_match = {};
        const history_ref01_list = (await history_ref01_ent.list(history_ref01_match)).map((e) => e.data());
        (0, node_assert_1.default)(!isempty(select(history_ref01_list, { id: history_ref01_data.id })));
        // REMOVE
        const history_ref01_match_rm0 = { id: history_ref01_data.id };
        await history_ref01_ent.remove(history_ref01_match_rm0);
        // LIST
        const history_ref01_match_rt0 = {};
        const history_ref01_list_rt0 = (await history_ref01_ent.list(history_ref01_match_rt0)).map((e) => e.data());
        (0, node_assert_1.default)(isempty(select(history_ref01_list_rt0, { id: history_ref01_data.id })));
    });
});
