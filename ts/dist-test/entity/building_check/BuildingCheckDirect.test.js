...
(0, node_test_1.describe)('BuildingCheckDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.LocationSharingSDK({
    ...
    (0, node_test_1.test)('direct-list-building_check', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-building_check', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.LOCATION_SHARING_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.LocationSharingSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['LOCATION_SHARING_TEST_BUILDING_CHECK_ENTID'];
    ...
    const client = new __1.LocationSharingSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=BuildingCheckDirect.test.js.map