...
(0, node_test_1.describe)('AddressEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(null != address_ref01_data_dt0);
    });
});
