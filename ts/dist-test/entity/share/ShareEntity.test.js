...
(0, node_test_1.describe)('ShareEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'share.' + op, live))
                return;
        }
        ...
        if (setup.syntheticOnly) {
            t.skip('live entity test uses synthetic IDs from fixture — set LOCATION_SHARING_TEST_SHARE_ENTID JSON to run live');
            return;
        }
        ...
        (0, node_assert_1.default)(null != share_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/share/ShareTestData.json');
    ...
    let idmap = transform(['share01', 'share02', 'share03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['LOCATION_SHARING_TEST_SHARE_ENTID'];
...
//# sourceMappingURL=ShareEntity.test.js.map