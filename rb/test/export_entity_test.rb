...
class ExportEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set LOCATIONSHARING_TEST_EXPORT_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def export_basic_setup(extra)
  ...
  entid_env_raw = ENV["LOCATIONSHARING_TEST_EXPORT_ENTID"]
  ...
  idmap_resolved = Helpers.to_map(
    env["LOCATIONSHARING_TEST_EXPORT_ENTID"])
