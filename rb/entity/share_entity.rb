...
class ShareEntity
  ...
  # @return [Share, Hash] the current Share data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Share fields)
  def match_get
  ...
  # Create a new Share.
  #
  # @param reqdata [ShareCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Share, Hash] the created Share; raises LocationSharingError on failure
