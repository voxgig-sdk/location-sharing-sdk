...
class MarkerEntity
  ...
  #
  # @param reqmatch [MarkerListMatch, Hash, nil] match filter (any subset of
  #   Marker fields); defaults to nil, treated as an empty match that lists all.
