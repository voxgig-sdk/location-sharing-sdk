...
class BuildingCheckEntity
  ...
  def make
    opts = @_entopts.dup
    BuildingCheckEntity.new(@_client, opts)
  end
  ...
  #
  # @param reqmatch [BuildingCheckListMatch, Hash, nil] match filter (any subset of
  #   BuildingCheck fields); defaults to nil, treated as an empty match that lists all.
