// Command LocationSharing-mcp is an MCP server exposing the LocationSharing
// SDK as MCP tools.
//
// Two tools are registered:
//
//	LocationSharing_list  — list records of an entity
//	LocationSharing_load  — load a single record of an entity
//
