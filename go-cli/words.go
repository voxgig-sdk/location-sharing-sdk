...
func registerSDKWords(r *eng.Registry, client *sdk.LocationSharingSDK) {
...
func runOp(client *sdk.LocationSharingSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
