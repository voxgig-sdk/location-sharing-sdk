...
AQL-driven CLI and REPL for the LocationSharing SDK. Positional arguments are
...
```sh
go build -o location-sharing-cli ./...
```
...
./location-sharing-cli list address
./location-sharing-cli load 1 address
./location-sharing-cli load '{id:1}' address
