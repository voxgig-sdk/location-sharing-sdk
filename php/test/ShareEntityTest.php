...
class ShareEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set LOCATIONSHARING_TEST_SHARE_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function share_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("LOCATIONSHARING_TEST_SHARE_ENTID");
