...
// LocationSharing SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (LocationSharingSDK::test)
...
{
    private const SDK_CLASS = 'LocationSharingSDK';
    ...
    private const SDK_BASE = 'locationsharing_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../locationsharing_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
