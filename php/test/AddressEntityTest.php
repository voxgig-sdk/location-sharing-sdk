...
class AddressEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set LOCATION_SHARING_TEST_ADDRESS_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function address_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("LOCATION_SHARING_TEST_ADDRESS_ENTID");
    ...
    $idmap_resolved = Helpers::to_map(
        $env["LOCATION_SHARING_TEST_ADDRESS_ENTID"]);
