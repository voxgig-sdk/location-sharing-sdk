...
class MarkerDirectTest extends TestCase
{
    public function test_direct_list_marker(): void
    {
        $setup = marker_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-marker", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
