...
// LocationSharing SDK pipeline test
//
...
{
    private static function utility(): LocationSharingUtility
    {
        return new LocationSharingUtility();
    }
    ...
    private static function ctx(array $over = []): LocationSharingContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new LocationSharingContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new LocationSharingOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof LocationSharingError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new LocationSharingOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = LocationSharingMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new LocationSharingOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = LocationSharingMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new LocationSharingOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = LocationSharingMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new LocationSharingSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = LocationSharingMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new LocationSharingResponse([]),
            'result' => new LocationSharingResult([]),
        ]);
        [, $err] = LocationSharingMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new LocationSharingSpec([]),
            'response' => null,
            'result' => new LocationSharingResult([]),
        ]);
        [, $err] = LocationSharingMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new LocationSharingSpec(['step' => 's']),
            'response' => new LocationSharingResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new LocationSharingResult([]),
        ]);
        [, $err] = LocationSharingMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new LocationSharingSpec(['step' => 's']),
            'response' => new LocationSharingResponse(self::resp(200, ['v' => 1])),
            'result' => new LocationSharingResult([]),
        ]);
        [, $err] = LocationSharingMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new LocationSharingSpec(['step' => 's']),
            'response' => new LocationSharingResponse(self::resp(200, ['v' => 2])),
            'result' => new LocationSharingResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        LocationSharingMakeResponse::call($ctx);
    ...
    {
        $preset = new LocationSharingResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new LocationSharingSpec([]),
            'response' => new LocationSharingResponse([]),
            'result' => new LocationSharingResult([]),
        ...
        [$got, $err] = LocationSharingMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new LocationSharingResult([])]);
        [, $err] = LocationSharingMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new LocationSharingSpec([]), 'result' => null]);
        [, $err] = LocationSharingMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new LocationSharingSpec(['step' => 's']),
            'result' => new LocationSharingResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new LocationSharingOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = LocationSharingMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new LocationSharingSpec(['step' => 's']),
            'result' => new LocationSharingResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new LocationSharingOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = LocationSharingMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new LocationSharingResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new LocationSharingSpec([]),
            'result' => new LocationSharingResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = LocationSharingMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = LocationSharingMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new LocationSharingError('boom', 'boom');
        $utility->fetcher = function (LocationSharingContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new LocationSharingSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = LocationSharingMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (LocationSharingContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = LocationSharingMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(LocationSharingResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        LocationSharingMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (LocationSharingContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new LocationSharingSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = LocationSharingMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new LocationSharingResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new LocationSharingSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = LocationSharingMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = LocationSharingMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = LocationSharingMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new LocationSharingResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, LocationSharingDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new LocationSharingResult(['ok' => false])]);
        $this->expectException(LocationSharingError::class);
        LocationSharingDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new LocationSharingResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', LocationSharingMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        LocationSharingMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new LocationSharingBaseFeature();
        $b = new LocationSharingBaseFeature();
        LocationSharingFeatureAdd::call($ctx, $a);
        LocationSharingFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): LocationSharingBaseFeature
    {
        $f = new LocationSharingBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        LocationSharingFeatureAdd::call($ctx, self::named_feature('a'));
        LocationSharingFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        LocationSharingFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        LocationSharingFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        LocationSharingFeatureAdd::call($ctx, $replace);
        ...
        LocationSharingFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): LocationSharingContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new LocationSharingSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = LocationSharingPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        LocationSharingPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new LocationSharingResponse(['headers' => null]),
            'result' => new LocationSharingResult([]),
        ]);
        LocationSharingResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        LocationSharingResultBody::call($ctx);
