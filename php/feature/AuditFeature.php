...
// LocationSharing SDK audit feature
...
class LocationSharingAuditFeature extends LocationSharingBaseFeature
{
    ...
    private function _emit(LocationSharingContext $ctx, string $outcome): void
    {
