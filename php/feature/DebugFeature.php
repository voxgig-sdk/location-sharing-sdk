...
// LocationSharing SDK debug feature
...
class LocationSharingDebugFeature extends LocationSharingBaseFeature
{
    ...
    private function _finish(LocationSharingContext $ctx, bool $ok): void
    {
