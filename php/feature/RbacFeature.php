...
// LocationSharing SDK rbac feature
...
class LocationSharingRbacFeature extends LocationSharingBaseFeature
{
    ...
    private function _required(LocationSharingContext $ctx): ?string
    {
    ...
    private function _reject(LocationSharingContext $ctx, string $required): void
    {
    ...
    private function _track(LocationSharingContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
