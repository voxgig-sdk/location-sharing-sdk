...
// LocationSharing SDK metrics feature
...
class LocationSharingMetricsFeature extends LocationSharingBaseFeature
{
    ...
    private function _record(LocationSharingContext $ctx, bool $ok): void
    {
