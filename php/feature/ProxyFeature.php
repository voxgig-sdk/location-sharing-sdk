...
// LocationSharing SDK proxy feature
...
class LocationSharingProxyFeature extends LocationSharingBaseFeature
{
    ...
    public function init(LocationSharingContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (LocationSharingContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
