...
// LocationSharing SDK clienttrack feature
...
class LocationSharingClienttrackFeature extends LocationSharingBaseFeature
{
    ...
    public function PostConstruct(LocationSharingContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'LocationSharing-SDK';
