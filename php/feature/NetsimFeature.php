...
// LocationSharing SDK netsim feature
...
class LocationSharingNetsimFeature extends LocationSharingBaseFeature
{
    ...
    private function _simulate(LocationSharingContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(LocationSharingContext $ctx, array $applied): void
    {
        $client = $this->client;
