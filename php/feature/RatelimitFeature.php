...
// LocationSharing SDK ratelimit feature
...
class LocationSharingRatelimitFeature extends LocationSharingBaseFeature
{
    ...
    private function _acquire(LocationSharingContext $ctx): void
    {
    ...
    private function _track(LocationSharingContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
