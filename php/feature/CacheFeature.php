...
// LocationSharing SDK cache feature
...
class LocationSharingCacheFeature extends LocationSharingBaseFeature
{
    ...
    private function _through(LocationSharingContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
