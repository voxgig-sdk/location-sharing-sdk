...
// LocationSharing SDK utility: result_basic

class LocationSharingResultBasic
{
    public static function call(LocationSharingContext $ctx): ?LocationSharingResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof LocationSharingError) ? $result->err->msg : (string)$result->err;
