...
// LocationSharing SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class LocationSharingTransformResponse
{
    public static function call(LocationSharingContext $ctx): mixed
    {
        ...
        $transform = LocationSharingHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
