...
The PHP SDK for the LocationSharing API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Address(null)->load(["id" => "example_id"], null);
...
[$result, $err] = $client->LocationSharing(null)->load(
    ["id" => "test01"], null
);
