...
// LocationSharing SDK utility type

class LocationSharingUtility
{
    ...
    public static function copy(LocationSharingUtility $src): LocationSharingUtility
    {
        $u = new LocationSharingUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
