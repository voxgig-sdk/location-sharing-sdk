...
class HistoryEntity
{
     ...
     *
     * @param HistoryCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed HistoryCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return History|array The created History as an assoc-array at the
     ...
     *
     * @param HistoryRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; HistoryRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return History|array The removed History as an assoc-array at the
     *   SDK boundary; throws LocationSharingError on failure (item-5 convention).
     */
