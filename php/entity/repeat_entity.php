...
// LocationSharing SDK Repeat entity
...
class RepeatEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new RepeatEntity($this->_client, $opts);
    }

    /**
     * @param Repeat|array $args Repeat data (assoc-array) to store.
     */
    ...
    /**
     * @return Repeat|array The current Repeat data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Repeat fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Repeat fields).
     */
     ...
     * Create a new Repeat.
     *
     * @param RepeatCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed RepeatCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Repeat|array The created Repeat as an assoc-array at the
        ...
        return $this->_run_op($ctx, function () use ($ctx) {
            if ($ctx->result) {
                if ($ctx->result->resdata) {
                    $this->_data = LocationSharingHelpers::to_map(Struct::clone($ctx->result->resdata)) ?? [];
                }
            }
        });
    }
