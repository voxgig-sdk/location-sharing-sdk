...
class BuildingCheckEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new BuildingCheckEntity($this->_client, $opts);
    }

    /**
     * @param BuildingCheck|array $args BuildingCheck data (assoc-array) to store.
     */
    public function data_set($args): void
    {
        if ($args) {
            $this->_data = LocationSharingHelpers::to_map(Struct::clone($args)) ?? [];
            ($this->_utility->feature_hook)($this->_entctx, "SetData");
        }
    }

    /**
     * @return BuildingCheck|array The current BuildingCheck data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of BuildingCheck fields).
     */
    public function match_set($args): void
    {
        if ($args) {
            $this->_match = LocationSharingHelpers::to_map(Struct::clone($args)) ?? [];
            ($this->_utility->feature_hook)($this->_entctx, "SetMatch");
        }
    }

    /**
     * @return array The current match filter (any subset of BuildingCheck fields).
     */
     ...
     *
     * @param BuildingCheckListMatch|array|null $reqmatch Match filter (any subset
     *   of BuildingCheck fields) as an assoc-array; BuildingCheckListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return BuildingCheck[]|array A list of BuildingCheck items as assoc-arrays at
