...
// LocationSharing SDK Share entity
...
class ShareEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ShareEntity($this->_client, $opts);
    }

    /**
     * @param Share|array $args Share data (assoc-array) to store.
     */
    ...
    /**
     * @return Share|array The current Share data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Share fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Share fields).
     */
     ...
     * Create a new Share.
     *
     * @param ShareCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ShareCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Share|array The created Share as an assoc-array at the
