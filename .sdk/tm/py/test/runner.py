...
class LocationSharingTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = LocationSharingTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = LocationSharingTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = LocationSharingTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
