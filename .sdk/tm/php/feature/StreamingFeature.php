...
// LocationSharing SDK streaming feature
...
class LocationSharingStreamingFeature extends LocationSharingBaseFeature
{
    ...
    private function _iterate(LocationSharingResult $result): \Generator
    {
    ...
    private function _streamable(LocationSharingContext $ctx): bool
    {
