...
// LocationSharing SDK timeout feature
...
class LocationSharingTimeoutFeature extends LocationSharingBaseFeature
{
    ...
    private function _with_timeout(LocationSharingContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(LocationSharingContext $_ctx, float $ms): void
    {
        $client = $this->client;
