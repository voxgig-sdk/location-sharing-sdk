...
// LocationSharing SDK utility: graphql
//
...
class LocationSharingGraphql
{
    ...
    // equivalent.
    public static function body(LocationSharingContext $ctx): mixed
    {
    ...
    public static function errors(LocationSharingContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
