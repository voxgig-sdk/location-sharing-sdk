...
// LocationSharing SDK utility: fetcher

class LocationSharingFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; LocationSharingSDK/1.0)';
    ...
    public static function call(LocationSharingContext $ctx, string $fullurl, array $fetchdef): array
    {
