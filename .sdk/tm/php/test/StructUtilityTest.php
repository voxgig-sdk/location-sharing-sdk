...
// LocationSharing SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = LocationSharingOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(LocationSharingOmni::structfix($now, Struct::undef()))
                        !== json_encode(LocationSharingOmni::structfix($val, Struct::undef()))) {
