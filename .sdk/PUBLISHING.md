...
|---|---|---|
| `ts/` | @voxgig-sdk/location-sharing-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/location-sharing-sdk \
      --repository voxgig-sdk/location-sharing-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/location-sharing-sdk` shows it, and
`npm trust revoke @voxgig-sdk/location-sharing-sdk --id=<id>` removes it.
