...
func NewMarkerEntity(client *core.LocationSharingSDK, entopts map[string]any) *MarkerEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *MarkerEntity) GetName() string { return e.name }
...
func (e *MarkerEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *MarkerEntity) Deleted() bool {
	return e.deleted
}


func (e *MarkerEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewMarkerEntity(e.client, opts)
}

func (e *MarkerEntity) Data(args ...any) any {
...
func (e *MarkerEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Marker; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *MarkerEntity) DataTyped(data ...Marker) Marker {
	if len(data) > 0 {
		return typedFrom[Marker](e.Data(asMap(data[0])))
	}
	return typedFrom[Marker](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Marker (all fields
// optional at the wire level).
func (e *MarkerEntity) MatchTyped(match ...Marker) Marker {
	if len(match) > 0 {
		return typedFrom[Marker](e.Match(asMap(match[0])))
	}
	return typedFrom[Marker](e.Match())
}
...
func (e *MarkerEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *MarkerEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *MarkerEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// MarkerListMatch and returns []Marker. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *MarkerEntity) ListTyped(reqmatch MarkerListMatch, ctrl map[string]any) ([]Marker, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Marker](res), nil
}




func (e *MarkerEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// MarkerCreateData and returns an Marker. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *MarkerEntity) CreateTyped(reqdata MarkerCreateData, ctrl map[string]any) (Marker, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return Marker{}, err
	}
	return typedFrom[Marker](res), nil
}



func (e *MarkerEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *MarkerEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// MarkerRemoveMatch and returns an Marker. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *MarkerEntity) RemoveTyped(reqmatch MarkerRemoveMatch, ctrl map[string]any) (Marker, error) {
...
func (e *MarkerEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
