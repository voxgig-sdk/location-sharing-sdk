...
func NewShareEntity(client *core.LocationSharingSDK, entopts map[string]any) *ShareEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ShareEntity) GetName() string { return e.name }
...
func (e *ShareEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ShareEntity) Deleted() bool {
	return e.deleted
}


func (e *ShareEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewShareEntity(e.client, opts)
}

func (e *ShareEntity) Data(args ...any) any {
...
func (e *ShareEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Share; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ShareEntity) DataTyped(data ...Share) Share {
	if len(data) > 0 {
		return typedFrom[Share](e.Data(asMap(data[0])))
	}
	return typedFrom[Share](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Share (all fields
// optional at the wire level).
func (e *ShareEntity) MatchTyped(match ...Share) Share {
	if len(match) > 0 {
		return typedFrom[Share](e.Match(asMap(match[0])))
	}
	return typedFrom[Share](e.Match())
}
...
func (e *ShareEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ShareEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *ShareEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *ShareEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ShareCreateData and returns an Share. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *ShareEntity) CreateTyped(reqdata ShareCreateData, ctrl map[string]any) (Share, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return Share{}, err
	}
	return typedFrom[Share](res), nil
}



func (e *ShareEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ShareEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ShareEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
