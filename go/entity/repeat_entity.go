...
func NewRepeatEntity(client *core.LocationSharingSDK, entopts map[string]any) *RepeatEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RepeatEntity) GetName() string { return e.name }
...
func (e *RepeatEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *RepeatEntity) Deleted() bool {
	return e.deleted
}


func (e *RepeatEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewRepeatEntity(e.client, opts)
}

func (e *RepeatEntity) Data(args ...any) any {
...
func (e *RepeatEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Repeat; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *RepeatEntity) DataTyped(data ...Repeat) Repeat {
	if len(data) > 0 {
		return typedFrom[Repeat](e.Data(asMap(data[0])))
	}
	return typedFrom[Repeat](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Repeat (all fields
// optional at the wire level).
func (e *RepeatEntity) MatchTyped(match ...Repeat) Repeat {
	if len(match) > 0 {
		return typedFrom[Repeat](e.Match(asMap(match[0])))
	}
	return typedFrom[Repeat](e.Match())
}
...
func (e *RepeatEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *RepeatEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *RepeatEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *RepeatEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// RepeatCreateData and returns an Repeat. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *RepeatEntity) CreateTyped(reqdata RepeatCreateData, ctrl map[string]any) (Repeat, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return Repeat{}, err
	}
	return typedFrom[Repeat](res), nil
}



func (e *RepeatEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *RepeatEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *RepeatEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
