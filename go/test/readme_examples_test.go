...
const testSeed = `map[string]any{"entity": map[string]any{"address": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "building_check": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "export": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "history": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "location": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "marker": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "repeat": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "search": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "share": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
