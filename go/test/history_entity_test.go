...
func TestHistoryEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		historyRef01Data = core.ToMapAny(entityData(historyRef01DataResult))
...
func historyBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("LOCATION_SHARING_TEST_HISTORY_ENTID")
	...
	idmapResolved := core.ToMapAny(env["LOCATION_SHARING_TEST_HISTORY_ENTID"])
