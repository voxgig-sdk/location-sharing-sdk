# LocationSharing SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions LocationSharingSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both LocationSharingSDK(...) and LocationSharingSDK.test(...) become
#      LocationSharingSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "locationsharing_sdk"
_SDK_CLASS = "LocationSharingSDK"
