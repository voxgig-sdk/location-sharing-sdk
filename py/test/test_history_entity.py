    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set LOCATIONSHARING_TEST_HISTORY_ENTID JSON to run live")
        client = setup["client"]
        ...
        history_ref01_data = helpers.to_map(history_ref01_ent.create(history_ref01_data, None))
...
def _history_basic_setup(extra):
    ...
    idmap_resolved = helpers.to_map(
        env.get("LOCATIONSHARING_TEST_HISTORY_ENTID"))
