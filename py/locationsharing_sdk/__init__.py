...
from locationsharing_sdk.utility import register

# Load features
from locationsharing_sdk.feature.base_feature import LocationSharingBaseFeature
from locationsharing_sdk.features import _has_feature, _make_feature
...
class LocationSharingSDK:
    ...
    def _op_denied(self, op):
        ...
        return {
            "ok": False,
            "err": Exception(
                "LocationSharingSDK: " + op + ": operation not allowed by"
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("LocationSharingSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Address(self, data=None) -> "AddressEntity":
        ...
        from locationsharing_sdk.entity.address_entity import AddressEntity
    ...
    def BuildingCheck(self, data=None) -> "BuildingCheckEntity":
        ...
        from locationsharing_sdk.entity.building_check_entity import BuildingCheckEntity
    ...
    def Export(self, data=None) -> "ExportEntity":
        ...
        from locationsharing_sdk.entity.export_entity import ExportEntity
    ...
    def History(self, data=None) -> "HistoryEntity":
        ...
        from locationsharing_sdk.entity.history_entity import HistoryEntity
    ...
    def Location(self, data=None) -> "LocationEntity":
        ...
        from locationsharing_sdk.entity.location_entity import LocationEntity
    ...
    def Marker(self, data=None) -> "MarkerEntity":
        ...
        from locationsharing_sdk.entity.marker_entity import MarkerEntity
    ...
    def Repeat(self, data=None) -> "RepeatEntity":
        ...
        from locationsharing_sdk.entity.repeat_entity import RepeatEntity
        return RepeatEntity(self, data)


    def Search(self, data=None) -> "SearchEntity":
        """Entity factory: client.Search().list() / client.Search().load({"id": ...})."""
        from locationsharing_sdk.entity.search_entity import SearchEntity
        return SearchEntity(self, data)


    def Share(self, data=None) -> "ShareEntity":
        """Entity factory: client.Share().list() / client.Share().load({"id": ...})."""
        from locationsharing_sdk.entity.share_entity import ShareEntity
