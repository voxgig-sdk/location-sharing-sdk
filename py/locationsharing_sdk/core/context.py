...
from locationsharing_sdk.core.control import LocationSharingControl
...
from locationsharing_sdk.core.helpers import get_ctx_prop, to_map
...
class LocationSharingContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = LocationSharingControl()
        ...
        if isinstance(sp, LocationSharingSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, LocationSharingResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, LocationSharingResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return LocationSharingOperation({})
    ...
    def make_error(self, code, msg):
        return LocationSharingError(code, msg, self)
