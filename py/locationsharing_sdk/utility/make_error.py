...
def make_error_util(ctx, err):
    if ctx is None:
        from locationsharing_sdk.core.context import LocationSharingContext
        ctx = LocationSharingContext({}, None)
    ...
    errmsg = ""
    if isinstance(err, LocationSharingError):
        errmsg = err.msg
    ...
    sdk_err = LocationSharingError("", msg, ctx)
