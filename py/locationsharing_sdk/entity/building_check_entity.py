...
from locationsharing_sdk.locationsharing_types import (
    BuildingCheck,
    BuildingCheckListMatch,
)
...
class BuildingCheckEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return BuildingCheckEntity(self._client, opts)
    ...
    def data_get(self) -> BuildingCheck:
    ...
    def match_get(self) -> BuildingCheck:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[BuildingCheck]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.BuildingCheck().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
