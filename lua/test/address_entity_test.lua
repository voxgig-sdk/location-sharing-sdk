...
describe("AddressEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set LOCATION_SHARING_TEST_ADDRESS_ENTID JSON to run live")
      return
    end
...
function address_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("LOCATION_SHARING_TEST_ADDRESS_ENTID")
