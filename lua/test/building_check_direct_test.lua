...
describe("BuildingCheckDirect", function()
  it("should direct-list-building_check", function()
    local setup = building_check_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-building_check", setup.live and "live" or "unit")
...
function building_check_direct_setup(mockres)
