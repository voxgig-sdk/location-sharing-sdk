...
local SDK_MODULE = "location-sharing_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["address"] = { ["test01"] = { id = "test01" } }, ["building_check"] = { ["test01"] = { id = "test01" } }, ["export"] = { ["test01"] = { id = "test01" } }, ["history"] = { ["test01"] = { id = "test01" } }, ["location"] = { ["test01"] = { id = "test01" } }, ["marker"] = { ["test01"] = { id = "test01" } }, ["repeat"] = { ["test01"] = { id = "test01" } }, ["search"] = { ["test01"] = { id = "test01" } }, ["share"] = { ["test01"] = { id = "test01" } } } }'
