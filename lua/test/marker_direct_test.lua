...
describe("MarkerDirect", function()
  it("should direct-list-marker", function()
    local setup = marker_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-marker", setup.live and "live" or "unit")
...
function marker_direct_setup(mockres)
