...
function runner.env_override(m)
  local live = runner.getenv("LOCATION_SHARING_TEST_LIVE")
  local override = runner.getenv("LOCATION_SHARING_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("LOCATION_SHARING_TEST_EXPLAIN")
