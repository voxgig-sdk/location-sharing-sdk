...
function runner.env_override(m)
  local live = runner.getenv("LOCATIONSHARING_TEST_LIVE")
  local override = runner.getenv("LOCATIONSHARING_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("LOCATIONSHARING_TEST_EXPLAIN")
