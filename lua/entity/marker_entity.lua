-- LocationSharing SDK Marker entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local MarkerEntity = {}
MarkerEntity.__index = MarkerEntity


function MarkerEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, MarkerEntity)
  self._name = "marker"
  self._client = client
...
function MarkerEntity:get_name()
  return self._name
end


function MarkerEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return MarkerEntity.new(self._client, opts)
end
...
function MarkerEntity:mark_deleted()
  self._deleted = true
end


function MarkerEntity:deleted()
  return true == self._deleted
end


function MarkerEntity:data_set(args)
  if args ~= nil then
...
function MarkerEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function MarkerEntity:match_set(args)
  if args ~= nil then
...
function MarkerEntity:match_get()
...
function MarkerEntity:stream(action, args, callopts)
...
function MarkerEntity:_run_op(ctx, post_done)
  local utility = self._utility
